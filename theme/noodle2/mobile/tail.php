...
<div id="ft">
    <div id="ft_info">
        ...
        <div id="ft_customer" class="col-xs-6 col-sm-6 col-md-3 ft_div">
            ...
            <ul class="ft_sns">
                <li class="ft_sns1"><a href="https://www.facebook.com/" target="_blank"><i class="fa fa-2x fa-facebook-square"></i></a></li>
                <li class="ft_sns2"><a href="https://twitter.com/" target="_blank"><i class="fa fa-2x fa-twitter-square"></i></a></li>
                <li class="ft_sns3"><a href="https://www.google.co.kr/?gws_rd=ssl" target="_blank"><i class="fa fa-2x fa-google-plus-square"></i></a></li>
                <li class="ft_sns4"><a href="http://instagram.com/" target="_blank"><i class="fa fa-2x fa-instagram"></i></a></li>
            </ul>
        </div>
