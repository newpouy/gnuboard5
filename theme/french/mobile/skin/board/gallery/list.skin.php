            ...
            <div class="gall_li_wr">
                ...
                <div class="hov_img">
	                <a href="<?php echo $list[$i]['href'] ?>" class="gall_img">
		                <a href="<?php echo $list[$i]['href'] ?>" class="img_link"><span>VIEW <i class="fa fa-arrow-right" aria-hidden="true"></i></span></a>
		                <?php
		                ...
		                ?>
		                <div class="hov_info">
	                        <?php if ($is_good) { ?><span class="sound_only">추천</span><strong class="hover_li"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> <?php echo $list[$i]['wr_good'] ?></strong><?php } ?>
							...
							<span class="sound_only">조회 </span><strong class="hover_li"><i class="fa fa-eye" aria-hidden="true"></i> <?php echo $list[$i]['wr_hit'] ?></strong>
						</div>
	                </a>
                </div>
