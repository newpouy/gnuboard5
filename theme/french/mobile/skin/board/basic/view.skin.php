...
<article id="bo_v" style="width:<?php echo $width; ?>">
    ...
    <section id="bo_v_atc">
        ...
        <div id="bo_v_act">
            ...
            <span class="bo_v_act_gng">
                <a href="<?php echo $good_href.'&amp;'.$qstr ?>" id="good_button" class="bo_v_good"><i class="fa fa-heart" aria-hidden="true"></i><br><span class="sound_only">추천</span><strong><?php echo number_format($view['wr_good']) ?></strong></a>
        ...
        ?>
        <div id="bo_v_act">
            <?php if($board['bo_use_good']) { ?><span class="bo_v_good"><i class="fa fa-heart" aria-hidden="true"></i><br><span class="sound_only">추천</span><strong><?php echo number_format($view['wr_good']) ?></strong></span><?php } ?>
        </div>
        <?php
            }
        }
    ...
    <ul class="bo_v_nb">
        <?php if ($prev_href) { ?>
        	<li class="bo_v_prev">
        		<a href="<?php echo $prev_href ?>" class="bo_nb_t"><i class="fa fa-chevron-left" aria-hidden="true"></i></a>
        		<span>이전글</span><br>
        		<a href="<?php echo $prev_href ?>" class="bo_nb_tit"><?php echo $prev_wr_subject;?></a>
        	</li>
        <?php } ?>
        <?php if ($next_href) { ?>
        	<li class="bo_v_next">
        		<a href="<?php echo $next_href ?>" class="bo_nb_t"><i class="fa fa-chevron-right" aria-hidden="true"></i></a>
        		<span>다음글 </span><br>	
        		<a href="<?php echo $next_href ?>" class="bo_nb_tit"><?php echo $next_wr_subject;?></a>
        	</li>
        <?php } ?>
    </ul>
    <?php } ?>
    ...
    <div class="btn_bottom">
    	<ul class="bo_v_option">
    		<li><a href="<?php echo $list_href ?>"><i class="fa fa-list" aria-hidden="true"></i> 목록</a></li>
    		<li><?php if ($reply_href) { ?><a href="<?php echo $reply_href ?>"><i class="fa fa-reply" aria-hidden="true"></i> 답변</a><?php } ?></li>
    		<?php if ($is_admin == 'super' || $is_auth) {  ?>
    		<li class="more_opt">
    			<button class="bo_vop_btn"><i class="fa fa-ellipsis-v" aria-hidden="true"></i><span class="sound_only">게시판 옵션 버튼 더보기 열기</span></button>
    			<div id="bo_vop_btn">
			        <?php ob_start(); ?>
			        <ul>
			            ...
			            <?php if ($move_href) { ?><li><a href="<?php echo $move_href ?>" class="btn_admin" onclick="board_move(this.href); return false;"><i class="fa fa-arrows" aria-hidden="true"></i> 이동</a></li><?php } ?>
		...
		<?php if ($write_href) { ?><a href="<?php echo $write_href ?>" class="bo_write_btn btn_b02 btn"><i class="fa fa-pencil" aria-hidden="true"></i> 글쓰기</a><?php } ?>
    </div>
