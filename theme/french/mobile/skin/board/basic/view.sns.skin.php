...
<div id="bo_v_sns">
	<h3>공유하기</h3>
	<ul>
	    <li><a href="<?php echo $facebook_url; ?>" target="_blank" class="sns_f"><i class="fa fa-facebook" aria-hidden="true"></i></a></li>
	    <li><a href="<?php echo $gplus_url; ?>" target="_blank" class="sns_g"><i class="fa fa-google" aria-hidden="true"></i></a></li>
	    <li><a href="<?php echo $twitter_url; ?>" target="_blank" class="sns_t"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>
	    <?php if(G5_IS_MOBILE && $config['cf_kakao_js_apikey']) { ?>
