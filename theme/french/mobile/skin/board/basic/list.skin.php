            ...
            <li class="<?php if ($list[$i]['is_notice']) echo "bo_notice"; ?>">
                ...
                <div class="bo_subject">
                    ...
                    <a href="<?php echo $list[$i]['href'] ?>" class="bo_subject">
                        ...
                        <?php if ($list[$i]['is_notice']) { ?><strong class="notice_icon"><i class="fa fa-volume-up" aria-hidden="true"></i><span class="sound_only">공지</span></strong><?php } ?>
                        <?php
                        ...
                        ?>
                        <span class="cnt_cmt"><?php if ($list[$i]['comment_cnt']) { ?><span class="sound_only">댓글</span><?php echo $list[$i]['comment_cnt']; ?><span class="sound_only">개</span><?php } ?> </span>
                    </a>
                </div>
                <ul class="bo_info">
                	<li><i class="fa fa-eye" aria-hidden="true"></i> <?php echo $list[$i]['wr_hit'] ?></li>
                	<li><i class="fa fa-heart-o" aria-hidden="true"></i> <?php if ($is_good) { ?><span class="td_num"><?php echo $list[$i]['wr_good'] ?></span><?php } ?></li>
