...
<button type="button" class="cmt_btn"><span class="cmt_btn_tit">댓글목록 <span class="cmt_num"><?php echo $write['wr_comment'] ?></span></span></button>
...
<section id="bo_vc">
    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        ...
        <div class="cmt_contents">
            ...
            ?>
                <ul class="bo_vc_act">
                    <?php if ($list[$i]['is_reply']) { ?><li class="reply_btn"><a href="<?php echo $c_reply_href; ?>" onclick="comment_box('<?php echo $comment_id ?>', 'c'); return false;">답변</a></li><?php } ?>
