...
<article id="bo_v">
    ...
    <ul class="bo_v_nb">
        <?php if ($prev_href) { ?><li class="bo_v_prev"><a href="<?php echo $prev_href ?>" class="bo_nb_t"><i class="fa fa-chevron-left" aria-hidden="true"></i> 이전글</a></li><?php } ?>
        <?php if ($next_href) { ?><li class="bo_v_next"><a href="<?php echo $next_href ?>" class="bo_nb_t">다음글 <i class="fa fa-chevron-right" aria-hidden="true"></i></a></li><?php } ?>
    </ul>
    <?php } ?>
    ...
    <div class="btn_bottom">
		...
		<?php if ($write_href) { ?><li><a href="<?php echo $write_href ?>" class="bo_write_btn btn_b02 btn"><i class="fa fa-pencil" aria-hidden="true"></i> 글쓰기</a></li><?php } ?>
