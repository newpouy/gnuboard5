...
<aside id="ol_after" class="ol">
    ...
    <div id="ol_after_hd">
        <span class="profile_img">
            ...
            <a href="<?php echo G5_BBS_URL ?>/member_confirm.php?url=register_form.php" id="ol_after_info"><span class="sound_only">정보수정</span>EDIT</a>
        </span>
        <strong><?php echo $nick ?>님</strong>
        <strong class="point"><?php echo $point ?> point</strong>
